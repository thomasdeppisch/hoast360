...
context.audioWorklet.addModule('wasm-worklet-processor.js').then(() => {
    ...
    const paramGainLin = gainWorkletNode.parameters.get('gainLin');

    $("#slGain").on('input', function () {
        // console.log($(this)[0].value);
        paramGainLin.value = $(this)[0].value;
        gainWorkletNode.port.postMessage('paramChange');
    });
