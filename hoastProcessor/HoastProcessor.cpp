...
void HoastProcessor::calculateRotationMatrix(float yaw_rad, float pitch_rad)
{
    ...
    // shRotationMatrix[0] = ca * cb;
    // shRotationMatrix[1] = sa * cb;
    // shRotationMatrix[2] = -sb;
    // shRotationMatrix[0 + rotMtxRowColSize] = -sa;
    // shRotationMatrix[1 + rotMtxRowColSize] = ca;
    // shRotationMatrix[2 + rotMtxRowColSize] = 0.0f;
    // shRotationMatrix[0 + 2 * rotMtxRowColSize] = ca * sb;
    // shRotationMatrix[1 + 2 * rotMtxRowColSize] = sa * sb;
    // shRotationMatrix[2 + 2 * rotMtxRowColSize] = cb;
